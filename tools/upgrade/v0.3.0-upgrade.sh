...
apply_upgrade_config() {
    info "Applying v0.3.0 upgrade configuration..."
...
EOF
    ...
    info "Successfully applied v0.3.0 upgrade configuration"
}

# Main execution
main() {
    info "Starting v0.3.0 upgrade process..."
    ...
    info "v0.3.0 upgrade process completed successfully"
}
