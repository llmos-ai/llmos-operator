...
func (a *settingGeneratingHandler) isNewResourceVersion(obj *v1.Setting) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *settingGeneratingHandler) storeResourceVersion(obj *v1.Setting) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
