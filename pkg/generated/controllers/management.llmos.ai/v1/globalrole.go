...
func (a *globalRoleGeneratingHandler) isNewResourceVersion(obj *v1.GlobalRole) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *globalRoleGeneratingHandler) storeResourceVersion(obj *v1.GlobalRole) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
