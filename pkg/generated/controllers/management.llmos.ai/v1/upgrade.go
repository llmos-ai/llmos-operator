...
func (a *upgradeStatusHandler) sync(key string, obj *v1.Upgrade) (*v1.Upgrade, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *upgradeGeneratingHandler) Remove(key string, obj *v1.Upgrade) (*v1.Upgrade, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *upgradeGeneratingHandler) Handle(obj *v1.Upgrade, status v1.UpgradeStatus) (v1.UpgradeStatus, error) {
...
func (a *upgradeGeneratingHandler) isNewResourceVersion(obj *v1.Upgrade) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *upgradeGeneratingHandler) storeResourceVersion(obj *v1.Upgrade) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
