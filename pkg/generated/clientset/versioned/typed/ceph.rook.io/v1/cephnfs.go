...
func (c *cephNFSs) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.CephNFS, err error) {
	result = &v1.CephNFS{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cephnfss").
...
func (c *cephNFSs) List(ctx context.Context, opts metav1.ListOptions) (result *v1.CephNFSList, err error) {
...
func (c *cephNFSs) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cephNFSs) Create(ctx context.Context, cephNFS *v1.CephNFS, opts metav1.CreateOptions) (result *v1.CephNFS, err error) {
	result = &v1.CephNFS{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cephnfss").
...
func (c *cephNFSs) Update(ctx context.Context, cephNFS *v1.CephNFS, opts metav1.UpdateOptions) (result *v1.CephNFS, err error) {
	result = &v1.CephNFS{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cephnfss").
...
func (c *cephNFSs) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *cephNFSs) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cephNFSs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.CephNFS, err error) {
	result = &v1.CephNFS{}
