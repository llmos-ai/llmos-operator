...
type SettingInterface interface {
	...
	UpdateStatus(ctx context.Context, setting *v1.Setting, opts metav1.UpdateOptions) (*v1.Setting, error)
...
func (c *settings) UpdateStatus(ctx context.Context, setting *v1.Setting, opts metav1.UpdateOptions) (result *v1.Setting, err error) {
	result = &v1.Setting{}
	err = c.client.Put().
		Resource("settings").
		Name(setting.Name).
