...
var (
	...
	LocalCacheDownloaderImage = NewSetting(LocalCacheDownloaderImageName, "ghcr.io/llmos-ai/downloader:main-head")
)
...
const (
	...
	LocalCacheDownloaderImageName    = "local-cache-downloader-image"
)
