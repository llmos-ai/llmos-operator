...
func (h *handler) OnChange(_ string, model *mlv1.Model) (*mlv1.Model, error) {
	...
	b, err := h.rm.NewBackendFromRegistry(model.Spec.Registry)
	if err != nil {
	...
	if err := b.CreateDirectory(modelRootDir); err != nil {
...
func (h *handler) OnRemove(_ string, model *mlv1.Model) (*mlv1.Model, error) {
	...
	if err := b.DeleteDirectory(model.Status.RootPath); err != nil {
