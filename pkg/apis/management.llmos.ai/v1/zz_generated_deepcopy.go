...
func (in *UpgradeManagedAddonStatus) DeepCopy() *UpgradeManagedAddonStatus {
	...
	out := new(UpgradeManagedAddonStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UpgradeStatus) DeepCopyInto(out *UpgradeStatus) {
	*out = *in
	...
	if in.UpgradeJobs != nil {
		...
		*out = make([]UpgradeJobStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PlanStatus != nil {
		...
		*out = make([]UpgradePlanStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ManagedAddonStatus != nil {
		in, out := &in.ManagedAddonStatus, &out.ManagedAddonStatus
		*out = make([]UpgradeManagedAddonStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
